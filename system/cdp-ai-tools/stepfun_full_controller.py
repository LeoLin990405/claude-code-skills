...
class StepFunFullController(UnifiedCDP):
    """阶跃AI完整功能控制器"""

    def __init__(self, auto_clear: bool = False):
        """初始化阶跃AI控制器"""
        super().__init__(ai_type="stepfun", auto_clear=auto_clear)
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="阶跃AI完整操作控制器")
    ...
    controller = StepFunFullController(auto_clear=args.auto_clear)
